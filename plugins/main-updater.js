...
cmd({
    ...
    try {
        ...
        const { data: zipData } = await axios.get("https://github.com/Dawensboytech/MINI-JESUS-CRASH-/archive/main.zip", { responseType: "arraybuffer" });
        ...
        const sourcePath = path.join(extractPath, "MINI-JESUS-CRASH-main");
